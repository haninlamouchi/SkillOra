...
class ForumController extends AbstractController
{
    ...
    // ✅ LISTE DES PUBLICATIONS — page publique (visiteurs autorisés)
    ...
    public function show(
        ...
        if ($currentUser) {
            ...
            if ($form->isSubmitted() && $form->isValid()) {
                ...
                // 🔔 Notifier le responsable propriétaire de la publication
                ...
                if ($responsable && $responsable->getId() !== $currentUser->getId()) {
                    try {
                        ...
                        // Mercure peut ne pas être disponible — on continue
                    }
                }
