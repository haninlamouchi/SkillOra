...
final class QuizController extends AbstractController
{
    ...
    public function index(int $formationId): Response
    {
        ...
        return $this->render('frontoffice/responsableformation/quiz/index.html.twig', [
            'formation' => $formation,
    ...
    public function new(int $formationId, Request $request): Response
    {
        ...
        return $this->render('frontoffice/responsableformation/quiz/new.html.twig', [
            'formation' => $formation,
            'form' => $form,
        ]);
    }
    ...
    public function show(int $formationId, Quiz $quiz): Response
    {
        ...
        return $this->render('frontoffice/responsableformation/quiz/show.html.twig', [
            'formation' => $formation,
            'quiz' => $quiz,
    ...
    public function edit(int $formationId, Quiz $quiz, Request $request): Response
    {
        ...
        return $this->render('frontoffice/responsableformation/quiz/edit.html.twig', [
            'formation' => $formation,
            'quiz' => $quiz,
            'form' => $form,
        ]);
    ...
    {
        if ($this->isCsrfTokenValid('delete_quiz' . $quiz->getId(), is_string($token = $request->request->get('_token')) ? $token : null)) {
            $this->em->remove($quiz);
            $this->em->flush();
