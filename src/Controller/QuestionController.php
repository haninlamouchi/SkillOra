...
final class QuestionController extends AbstractController
{
    ...
    public function new(int $formationId, int $quizId, Request $request): Response
    {
        ...
        return $this->render('frontoffice/responsableformation/question/new.html.twig', [
            'formation' => $formation,
            'quiz' => $quiz,
            'form' => $form,
        ]);
    ...
    public function edit(int $formationId, int $quizId, Question $question, Request $request): Response
    {
        ...
        return $this->render('frontoffice/responsableformation/question/edit.html.twig', [
            'formation' => $formation,
            'quiz' => $quiz,
            'question' => $question,
            'form' => $form,
    ...
    public function delete(int $formationId, int $quizId, Question $question, Request $request): Response
    {
        ...
        if ($this->isCsrfTokenValid('delete_question' . $question->getId(), is_string($token = $request->request->get('_token')) ? $token : null)) {
