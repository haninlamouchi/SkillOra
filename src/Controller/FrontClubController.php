...
class FrontClubController extends AbstractController
{
    ...
    public function rejoindre(
        ...
        if (!$this->isCsrfTokenValid('rejoindre' . $club->getId(), is_string($token = $request->request->get('_token')) ? $token : null)) {
        ...
        $demande->setUser($user instanceof \App\Entity\User ? $user : null);
