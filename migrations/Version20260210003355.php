 ...
 */
final class Version20260210003355 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Commentaire (id_Commentaire INT AUTO_INCREMENT NOT NULL, contenu LONGTEXT NOT NULL, date_commentaire DATETIME NOT NULL, id_User INT NOT NULL, id_Publication INT NOT NULL, INDEX IDX_E16CE76BA6816575 (id_User), INDEX IDX_E16CE76B31B22559 (id_Publication), PRIMARY KEY (id_Commentaire)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE DemandeAdhesion (id_DemandeAdhesion INT AUTO_INCREMENT NOT NULL, date_inscription DATETIME NOT NULL, id_User INT NOT NULL, id_Club INT NOT NULL, INDEX IDX_F000A040A6816575 (id_User), INDEX IDX_F000A04093FC8B4E (id_Club), PRIMARY KEY (id_DemandeAdhesion)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE Participation (id_Participation INT AUTO_INCREMENT NOT NULL, date_participation DATETIME NOT NULL, id_Challenge INT NOT NULL, id_Groupe INT NOT NULL, INDEX IDX_182BA9BAD5CDB7D5 (id_Challenge), INDEX IDX_182BA9BA25223CFA (id_Groupe), PRIMARY KEY (id_Participation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
